...
one16 = ones(16,1);
rho = 0.8*one16; %[0.8*ones(4,1);0.6*ones(10,1);1;1];
alpha = 0.25; % Prob that infected asymptomatic infects
beta  = 0.016d0; % Prob. that infectious transmits disease to susceptible
...
I0   = 400*Nis/N_tot; % Number of infected initially, populated as population age fractions
S0  = Nis-3*I0; % Initial number of susceptible in age group, E0 = I0
A = [rho,kappa,gamma,mu_n,mu_d,w_s,w_w,w_h,w_o,Nis,I0,S0];
t_l1    = 500; % Lockdown onset
t_l2    = 600; % Lockdown stop
